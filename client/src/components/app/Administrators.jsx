...
const Administrators = () => {
	...
	let adminLoading = useSelector((state) => state.admins?.isLoading);
	let admins = useSelector((state) => state.admins?.admins);
											...
											<tr key={index} className="">
												...
												<td className="px-4 py-3">
													<div className="flex items-center justify-end text-right">
														...
														<div className="p-2 cursor-pointer text-gray-400 hover:text-green-600">
															<IconButton
																onClick={(e) => handleEditPopup(admin, e)}
															>
																<svg
																	stroke="currentColor"
																	fill="none"
					...
					<div className="px-4 py-3 border-t border-gray-200 dark:border-gray-700 bg-white text-gray-500 dark:text-gray-400 dark:bg-gray-800">
						<div className="flex flex-col justify-between text-xs sm:flex-row text-gray-600 dark:text-gray-400">
							<span className="flex items-center font-semibold tracking-wide uppercase">
								Showing 1-{admins.length} of {admins.length ? admins.length : 0}
							</span>
							<div className="flex mt-2 sm:mt-auto sm:justify-end">
								<TablePagination
									...
									count={admins.length ? admins.length : 0}
